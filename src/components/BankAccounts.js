...
const BankAccounts = ({input,setInput,disa}) => {
    ...
    return(
        <>
            ...
            <Form.Group as={Row} className="mb-3" controlId="URL">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="URL" name="URL" value={URL} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="User">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="User" name="User" value={User} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="Email">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="Email" name="Email" value={Email} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="Password">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="Password" name="Password" value={Password} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="AccNum">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="AccNum" name="AccNum" value={AccNum} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="CardNum">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="CardNum" name="CardNum" value={CardNum} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="ExpDate">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="ExpDate" name="ExpDate" value={ExpDate} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="CVV">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="CVV" name="CVV" value={CVV} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="PasswordCard">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="PasswordCard" name="PasswordCard" value={PasswordCard} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
        </>
    );
