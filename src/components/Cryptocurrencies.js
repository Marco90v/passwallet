...
const Cryptocurrencies = ({input,setInput,disa}) => {
    ...
    return(
        <>
            ...
            <Form.Group as={Row} className="mb-3" controlId="Wallet">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="Wallet" name="Wallet" value={Wallet} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
            ...
            <Form.Group as={Row} className="mb-3" controlId="SecretPhr">
                ...
                <Col sm={4}>
                    <Form.Control size="sm" type="text" placeholder="SecretPhr" name="SecretPhr" value={SecretPhr} onChange={(e)=>{setInput(e)}} disabled={disa} />
                </Col>
            </Form.Group>
